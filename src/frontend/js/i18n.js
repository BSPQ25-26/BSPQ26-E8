(function () {
  ...
  const dictionaries = {
    en: {
      ...
      'profile.submissionViewOptions': 'Submission view options',
      'profile.latestSubmission': 'Latest',
      'profile.bestSubmission': 'Best',
      'profile.filterByProblem': 'Filter by problem',
      'profile.allSubmittedProblems': 'All submissions',
      'profile.problemTitle': 'Problem',
      'profile.problemFallback': 'Problem {{id}}',
      'profile.submissionStatus': 'Status',
      'profile.submissionTests': 'Tests',
      'profile.submittedAt': 'Submitted',
      'profile.retrySubmission': 'Retry',
      'profile.editProblem': 'Edit',
      'profile.deleteProblem': 'Delete',
      'profile.confirmDeleteProblem': 'Are you sure you want to delete this problem? This action cannot be undone.',
      'profile.deleteProblemFailed': 'Could not delete the problem. You may not have permission.',
      'profile.submissionStatusQueued': 'Queued',
      'profile.submissionStatusRunning': 'Running',
      'profile.submissionStatusAccepted': 'Accepted',
      'profile.submissionStatusPassed': 'Passed',
      'profile.submissionStatusCompleted': 'Completed',
      'profile.submissionStatusFailed': 'Failed',
      'profile.submissionStatusWrongAnswer': 'Wrong answer',
      'profile.submissionStatusRuntimeError': 'Runtime error',
      'profile.submissionStatusCompileError': 'Compile error',
      'profile.submissionStatusCompilationError': 'Compilation error',
      'profile.submissionStatusTimeLimitExceeded': 'Time limit exceeded',
      'profile.submissionStatusMemoryLimitExceeded': 'Memory limit exceeded',
      'profile.submissionStatusInternalError': 'Internal error',
    ...
    es: {
      ...
      'profile.submissions': 'Soluciones',
      'profile.difficultyBreakdown': 'Desglose de dificultad (soluciones)',
      'profile.none': 'Ninguno',
      'profile.languageFallback': 'Lang {{id}}',
      'profile.myProblems': 'Mis problemas',
      'profile.mySubmissions': 'Mis soluciones',
      'profile.noProblems': 'Todavía no has creado problemas.',
      'profile.noSubmissions': 'Todavía no hay soluciones.',
      'profile.noSubmissionForView': 'No se ha encontrado ninguna solución para esta vista.',
      'profile.couldNotLoadProblems': 'No se han podido cargar tus problemas.',
      'profile.couldNotReachServer': 'No se ha podido conectar con el servidor.',
      'profile.submissionViewOptions': 'Opciones de vista de soluciones',
      'profile.latestSubmission': 'Último',
      'profile.bestSubmission': 'Mejor',
      'profile.filterByProblem': 'Filtrar por problema',
      'profile.allSubmittedProblems': 'Todas las soluciones',
      'profile.problemTitle': 'Problema',
      'profile.problemFallback': 'Problema {{id}}',
      'profile.submissionStatus': 'Estado',
      'profile.submissionTests': 'Pruebas',
      'profile.submittedAt': 'Enviado',
      'profile.retrySubmission': 'Reintentar',
      'profile.editProblem': 'Editar',
      'profile.deleteProblem': 'Eliminar',
      'profile.confirmDeleteProblem': '¿Seguro que quieres eliminar este problema? Esta acción no se puede deshacer.',
      'profile.deleteProblemFailed': 'No se ha podido eliminar el problema. Puede que no tengas permiso.',
      'profile.submissionStatusQueued': 'En cola',
      'profile.submissionStatusRunning': 'Ejecutando',
      'profile.submissionStatusAccepted': 'Aceptado',
      'profile.submissionStatusPassed': 'Superado',
      'profile.submissionStatusCompleted': 'Completado',
      'profile.submissionStatusFailed': 'Fallido',
      'profile.submissionStatusWrongAnswer': 'Respuesta incorrecta',
      'profile.submissionStatusRuntimeError': 'Error en ejecución',
      'profile.submissionStatusCompileError': 'Error de compilación',
      'profile.submissionStatusCompilationError': 'Error de compilación',
      'profile.submissionStatusTimeLimitExceeded': 'Límite de tiempo superado',
      'profile.submissionStatusMemoryLimitExceeded': 'Límite de memoria superado',
      'profile.submissionStatusInternalError': 'Error interno',
    ...
    ja: {
      ...
      'profile.myProblems': '自分の問題',
      'profile.mySubmissions': '自分の提出',
      'profile.noProblems': '作成した問題はまだありません。',
      'profile.noSubmissions': '提出はまだありません。',
      'profile.noSubmissionForView': 'この表示に該当する提出はありません。',
      'profile.couldNotLoadProblems': '問題を読み込めませんでした。',
      'profile.couldNotReachServer': 'サーバーに接続できませんでした。',
      'profile.submissionViewOptions': '提出の表示オプション',
      'profile.latestSubmission': '最新',
      'profile.bestSubmission': 'ベスト',
      'profile.filterByProblem': '問題で絞り込み',
      'profile.allSubmittedProblems': 'すべての提出',
      'profile.problemTitle': '問題',
      'profile.problemFallback': '問題 {{id}}',
      'profile.submissionStatus': '状態',
      'profile.submissionTests': 'テスト',
      'profile.submittedAt': '提出日時',
      'profile.retrySubmission': '再試行',
      'profile.editProblem': '編集',
      'profile.deleteProblem': '削除',
      'profile.confirmDeleteProblem': 'この問題を削除しますか？この操作は取り消せません。',
      'profile.deleteProblemFailed': '問題を削除できませんでした。権限がない可能性があります。',
      'profile.submissionStatusQueued': '待機中',
      'profile.submissionStatusRunning': '実行中',
      'profile.submissionStatusAccepted': '承認済み',
      'profile.submissionStatusPassed': '合格',
      'profile.submissionStatusCompleted': '完了',
      'profile.submissionStatusFailed': '失敗',
      'profile.submissionStatusWrongAnswer': '不正解',
      'profile.submissionStatusRuntimeError': '実行時エラー',
      'profile.submissionStatusCompileError': 'コンパイルエラー',
      'profile.submissionStatusCompilationError': 'コンパイルエラー',
      'profile.submissionStatusTimeLimitExceeded': '時間制限超過',
      'profile.submissionStatusMemoryLimitExceeded': 'メモリ制限超過',
      'profile.submissionStatusInternalError': '内部エラー',
